(function(window,undefined){$(document).click(function(e){e=e||event;$.lastClickedGrid=$(e.target).closest(".kgGrid")[0]||$(e.srcElement).closest(".kgGrid")[0];});ko.kgMoveSelection=function(sender,evt){var offset,charCode=(evt.which)?evt.which:event.keyCode;switch(charCode){case 38:offset=-1;break;case 40:offset=1;break;}
