...
var dba=getElementsByAttribute(document.body,"DIV","data-bind","koGrid",true);var len=dba.length,i=0;for(;i<len;i++){if(dba[i]!==undefined){if(dba.indexOf("keydown")==-1){var cas=$(dba)[i].getAttribute("data-bind")
$(dba[i]).attr("data-bind","event: { keydown: ko.kgMoveSelection }, "+cas);}}}
ko.kgMoveSelection=function(sender,evt){var offset,charCode=(evt.which)?evt.which:event.keyCode;switch(charCode){case 38:offset=-1;break;case 40:offset=1;break;default:return true;}
