...
//set event binding on the grid so we can select using the up/down keys
        ...
        self.setDraggables = function () {
            if (!grid.config.jqueryUIDraggable) {
                ...
                if (navigator.userAgent.indexOf("MSIE") != -1) {
                    ...
                    grid.$root.find('.kgHeaderSortColumn').bind('selectstart', function () {
                        this.dragDrop();
                        return false;
                    });
                }
        ...
        self.getGrouping = function (groups) {
            ...
            $.each(data, function (i, item) {
                ...
                $.each(groups, function (depth, group) {
                    if (cols[depth] && !cols[depth].isAggCol && depth <= maxDepth) {
    ...
    window.kg.Grid = function (options) {
        var defaults = {
                ...
                gridDim: new window.kg.Dimension({ outerHeight: ko.observable(0), outerWidth: ko.observable(0) }),
        ...
        self.config.columnDefs = ko.utils.unwrapObservable(self.config.columnDefs);
